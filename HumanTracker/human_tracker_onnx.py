...
from HumanTracker.utils.yolox_utils import (
    pre_process,
    post_process,
    multiclass_nms,
)
from HumanTracker.tracker.byte_tracker import BYTETracker


class HumanTrackerONNX(object):
    def __init__(self, args, execution_provider):
        self.args = args
        ...
        print("Excecution Provider: ", execution_provider)
        
        self.session = onnxruntime.InferenceSession(args.model, providers=[execution_provider]) #CUDAExecutionProvider CPUExecutionProvider TensorrtExecutionProvider
